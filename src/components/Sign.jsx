...
function Sign (){
    ...
    return(
        ...
        <h2>Sign up </h2>
        {response===1?<p>You signed up successfully <Link to="/PhpReactShoppingList/login">Click here to login</Link></p>:response===0?<p>Email address or username is already registered</p>:""}
            <label>
                <p>Name:</p>
